		...
		<div class="py-4 px-8 flex items-center justify-between">
			<div class="flex items-center">
				<a href="/" class="flex flex-row items-center" title="Gå til forsiden">
					<img
						class="h-10"
						src="https://images.ctfassets.net/wi3d49ltoppx/5Zbi1sNCknc8P5EQwPywXa/e544ebc2ff7d64bcc6e30247358b2729/bte.jpeg?fm=webp"
					/>
				</a>
			</div>
			...
			{#if menuItems?.length > 0}
				...
				<div class="block lg:hidden">
					...
					>
						<svg class:hidden={isOpen} class="h-4 fill-current" viewBox="0 0 122.88 95.95">
							<g>
								<path
									class="st0"
						...
						<svg class:hidden={!isOpen} class="h-4 fill-current" viewBox="0 0 122.878 122.88">
							<g>
								<path
