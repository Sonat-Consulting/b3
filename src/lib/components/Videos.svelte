...
<section class="px-8 md:px-0">
	<div class="grid grid-cols-12 grid-rows-6 gap-x-8">
		<div
			class="row-start-5 row-span-2 lg:row-span-6 col-span-12 lg:col-span-3 flex flex-col justify-center"
		>
		...
		<div
			...
			class="relative row-span-4 lg:row-span-6 col-span-12 lg:col-span-9 lg:col-start-4"
		>
